...
#CALL IMU FUNCTION TO GET STATE, PUT IN 6 VARIABLE LIST

## Next few lines are stuff for setup that will stay the same
time_step = .02 #1/frequency, in seconds
...
event_mat =  [[0,.25,.1,3,1.25,.01], [0,.25,.1,2,-.517,.05], [0,.25,.1,2,0,.05], [0,.25,.1,3,1.5,.05] ]
