...
while end_con == 0:
    ...
    if event_complete == 0: #case 1 of 4 is you're in the middle of a maneuver
        ...
        vel_tol = .5*math.pi/180 #tolerance in rad/s
        torque = [0, 0, 0]
    ...
    current_state[4] += dt*ang_accl[0][1]
    current_state[5] += dt*ang_accl[0][2]
